...
from integration.fixtures.docker_device import DockerDeviceAdapter
...
class DockerDeviceFixture:
    """Test device fixture to use in integration tests"""
    ...
    def create_device(
        ...
        Args:
            device_id (str, optional): Device id. defaults to cube-01
            device_type (str, optional): Device type. defaults to cube
        ...
        Returns:
            DockerDeviceAdapter: The docker device simulator
        """
        ...
        device = DockerDeviceAdapter(device_id)
        device.test_start_time = test_start
    ...
    def remove_device(self, container: Union[str, Container], alias: str = ""):
        ...
        Args:
            ...
            alias (str): Device alias (i.e. cube-01)
        """
    ...
    def get_device_container(self, name: str) -> Optional[Container]:
        ...
        Args:
            name (str): Device container alias (i.e. cube-01)
